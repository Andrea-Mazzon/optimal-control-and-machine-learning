...
public class CoinGamblerProblemWithQLearningTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.stream(valueFunctions).average().getAsDouble());
		
		final Plot2D plotValueFunctions = new Plot2D(1, amountOfMoneyToReach, amountOfMoneyToReach, Arrays.asList(
