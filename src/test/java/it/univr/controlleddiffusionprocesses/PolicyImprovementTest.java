...
public class PolicyImprovementTest {
	...
	public static void main(String[] args) throws Exception {
		...
		double analyticOptimalControl = (constantDrift - interestRate)/(constantSigma*constantSigma*(1-exponentForFinalRewardFunction));

		System.out.println("Analytic optimal control " +  formatterForControl.format(analyticOptimalControl));
		System.out.println();
		...
		double beta = 0.5 * constantSigma * constantSigma * analyticOptimalControl *  analyticOptimalControl * exponentForFinalRewardFunction * (exponentForFinalRewardFunction - 1)
				+ (constantDrift-interestRate)*exponentForFinalRewardFunction*analyticOptimalControl+interestRate*exponentForFinalRewardFunction;
