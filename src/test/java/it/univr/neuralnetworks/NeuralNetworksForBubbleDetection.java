...
public class NeuralNetworksForBubbleDetection {
	...
	public static void main(String[] args) {
		...
		//the interval where we generate the random exponents for non-bubbles
		double smallestExponentTrueMartingales = 0.5;
		double biggestExponentTrueMartingales = 1;
		
		//the interval where we generate the random exponents for bubbles
		...
		for (int i = 0; i < numberOfStrictLocalMartingalesForTraining; i++ ){
			...
			//generations of exponents in the interval of bubbles
		...
		for (int i = numberOfStrictLocalMartingalesForTraining; i < numberOfRowsMatrixTraining; i++ ){
			...
			//generations of exponents in the interval of non-bubbles
			double randomNumber = randomGenerator.nextDouble();
		...
		/*
		 * They will be 1 for bubbles, 0 for non-bubbles. So we hope that the network "learns the rule" that associates
		...
		System.out.println("Probabilities outputs that underlyings are bubbles");
